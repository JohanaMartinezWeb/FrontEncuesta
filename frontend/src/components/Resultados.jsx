...
const Resultados = () => {
  ...
  const ShowButton = () => (
    <Link
      className="btn-custom text-decoration-none font-weight-bold mb-5 px-2 py-4 rounded-lg text-center text-white "
          ...
          <div className="w-100 bg-white d-flex flex-column border-t border-gray-300 border-top-0 rounded-lg self-start px-3 py-3 ">
            <div className="d-flex flex-column justify-content-between">
              <div className="d-flex flex-row flex-md-column">
                <p className="font-weight-bold d-none d-md-inline-block mt-2 mb-4 home text-center">
